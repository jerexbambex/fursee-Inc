<x-guest-layout>
    <section class="fa">
        ...
        <div class="oq i_ uj dt fa">
            <div class="fe aw vx vw">
                <div class="o_ i_ lt">
                    <h1 class="h1 sm" data-aos="fade-up">About Us</h1>
                    <p class="text-xl sj " data-aos="fade-up" data-aos-delay="200">Shaping the future by empowering
                        businesses with smart technologies.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="oq i_ uj dt">
            <div class="as vd">
                <div class="o_ i_ lt aw vw">
                    <h2 class="text-blue-gray-800 h2 sm font-circular-head dark:text-gray-200">Bringing the world's ideas to life
                    </h2>
                    <p class="text-fuchsia-900 rz dark:text-gray-400 font-circular">We are a global IT company providing strategic IT
                        business solutions and services for complex business problems.</p>
                </div>
                <div class="nv wq">
                    <div class="dd mu me nw">
                        <div class="ok vu vz i_ ml gp sj ve dx" data-aos="fade-up"><img class="oz i_ vu ry"
                                src="/open-pro/images/features-03-image-01.png" width="540" height="405"
                                alt="Features 01"></div>
                        <div class="ok vu vz i_ mc gp" data-aos="fade-right">
                            <div class="vv gi gg">
                                {{-- <div class="text-purple-600 br rz sa">More speed. Less spend</div> --}}
                                <h3 class="text-blue-gray-700 h3 sh dark:text-gray-200 font-circular">Keep projects on schedule</h3>
                                <p class="text-gray-600 rz sm dark:text-gray-400">Fursee Inc. delivers your projects
                                    right on schedule without delay.</p>
                                <ul class="text-gray-600 rq ou dark:text-gray-400">
                                    <li class="np nw sa"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>Agile Development</span></li>
                                    <li class="np nw sa"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>Scrum Development</span></li>
                                    <li class="np nw"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>Version Control System</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="dd mu me nw">
                        <div class="ok vu vz i_ ml gp sj ve md" data-aos="fade-up"><img class="oz i_ vu ry"
                                src="/open-pro/images/features-03-image-02.png" width="540" height="405"
                                alt="Features 02"></div>
                        <div class="ok vu vz i_ mc gp" data-aos="fade-left">
                            <div class="xz kz _c">
                                {{-- <div class="text-purple-600 br rz sa">More speed. Less spend</div> --}}
                                <h3 class="text-blue-gray-700 h3 sh dark:text-gray-200">Develop Cross-Platform</h3>
                                <p class="text-gray-600 rz sm dark:text-gray-400">We build solutions for different
                                    platforms which can be synced with a well structured API.</p>
                                <ul class="text-gray-600 rq ou dark:text-gray-400">
                                    <li class="np nw sa"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        </svg> <span>Web Platform</span></li>
                                    <li class="np nw sa"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>Android Platform</span></li>
                                    <li class="np nw"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>iOS Development</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="dd mu me nw">
                        <div class="ok vu vz i_ ml gp sj ve dx" data-aos="fade-up"><img class="oz i_ vu ry"
                                src="/open-pro/images/features-03-image-03.png" width="540" height="405"
                                alt="Features 03"></div>
                        <div class="ok vu vz i_ mc gp" data-aos="fade-right">
                            <div class="vv gi gg">
                                {{-- <div class="text-purple-600 br rz sa">More speed. Less spend</div> --}}
                                <h3 class="text-blue-gray-700 h3 sh dark:text-gray-200">Quality Assurance</h3>
                                <p class="text-gray-600 rz sm dark:text-gray-400">We will help you establish concrete
                                    control over your product’s life cycle, monitor every development stage, and give
                                    you accurate product quality information.</p>
                                <ul class="text-gray-600 rq ou dark:text-gray-400">
                                    <li class="np nw sa"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        </svg> <span>Proper project management</span></li>
                                    <li class="np nw sa"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>Software testing</span></li>
                                    <li class="np nw"><svg class="cr rc fj ld su rn" viewBox="0 0 12 12"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z">
                                            </path>
                                        </svg> <span>Professional feedback</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section>
        <div class="oq i_ uj dt">
            <div class="as vd nu yv">
                <div class="o_ i_ lt aw vy">
                    <h1 class="text-blue-gray-700 h2 sm dark:text-gray-200">Our customers span the globe</h1>
                    <p class="text-fuchsia-900 rz dark:text-gray-400">Developing a competitive advantage calls for developing more intelligent software solutions.</p>
                </div>
                <div class="nv cb wz kf" data-aos-id-clients="">
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-anchor="[data-aos-id-clients]">
                        <svg
                            class="oz fj la" width="124" height="24" viewBox="0 0 124 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="83" height="30"
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="125" height="39"
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="113" height="30"
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="109" height="36"
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="150" height="30"
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="600" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="109" height="33"
                    ...
                    <div class="np nw nj ba no tj uc" data-aos="fade-up" data-aos-delay="700" data-aos-anchor="[data-aos-id-clients]">
                        <svg class="oz fj la" width="126" height="36"
