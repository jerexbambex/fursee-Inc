<x-guest-layout>
        ...
        <div class="oq i_ uj dt fa dark:bg-gray-900">
            ...
            <div class="fa fe wu vx vy">
                <div class="o_ i_ lt aw vy">
                    <h1 class="text-gray-700 dark:text-gray-100 h1 my-h1 sm font-circular-head" data-aos="fade-up">Build
                        and launch with FURSEE</h1>
                    <p class="text-gray-700 dark:text-gray-100 rz lu sj font-circular-regular" data-aos="fade-up"
        ...
        <div class="oq i_ uj dt">
            <div class="wo aw vg vw">
                <div class="o_ i_ lt aw vw">
                    <h2 class="h2 sm" data-aos="fade-up">Built exclusively for you</h2>
                    <p class="rz lu" data-aos="fade-up" data-aos-delay="200">Excepteur sint occaecat cupidatat non
                        proident, sunt in culpa qui officia deserunt mollit laborum — semper quis lectus nulla.</p>
                </div>
                <div class="ox i_ nv cx ms _o nb vu">
                    <div class="fa np ng nw" data-aos="fade-up">
                        ...
                        <h4 class="h4 sa">
                            <span class="lu">1</span>. Acquisition
                        </h4>
                        <p class="rq lu lt">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore
                    ...
                    <div class="fa np ng nw" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h4 class="h4 sa">
                            <span class="lu">2</span>. Activation
                        </h4>
                        <p class="rq lu lt">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore
                            eu fugiat nulla pariatur.</p>
                    </div>
                    <div class="fa np ng nw" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h4 class="h4 sa">
                            <span class="lu">3</span>. Retention
                        </h4>
                        <p class="rq lu lt">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore
                            eu fugiat nulla pariatur.</p>
                    </div>
    ...
    <section class="i_ uj dt dark:bg-gray-900">
        <div class="skew skew-top mr-for-radius">
            <svg class="w-full h-8 md:h-12 lg:h-20 text-gray-50 dark:text-gray-900" viewBox="0 0 10 10" preserveAspectRatio="none">
                <polygon fill="currentColor" points="0 0 10 10 0 10"></polygon>
            </svg>
        </div>
        <div class="skew skew-top ml-for-radius dark:bg-gray-900">
            <svg class="w-full h-8 md:h-12 lg:h-20 text-gray-50 dark:text-gray-900" viewBox="0 0 10 10" preserveAspectRatio="none">
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-full mb-12 lg:w-1/2 lg:mb-0">
                        <div class="max-w-md lg:mx-auto" data-aos="fade-up" data-aos-delay="200">
                            <span class="font-bold text-green-600">Dolor sit amet consectutar</span>
                            <h2 class="my-2 text-4xl font-bold lg:text-5xl font-heading">Build &amp; Launch without
                                problems</h2>
                            <p class="mb-6 leading-loose text-gray-500">Lorem ipsum dolor sit amet, consectetur
                    ...
                    <div class="flex flex-wrap w-full -mx-4 lg:w-1/2">
                        <div class="w-full px-4 mb-8 lg:mb-0 md:w-1/2">
                            <div class="py-6 pl-6 pr-4 mb-8 bg-white rounded shadow" data-aos="fade-in" data-aos-delay="200">
                                ...
                                <h4 class="mb-2 text-2xl font-bold font-heading">Lorem ipsum dolor sit amet</h4>
                                <p class="leading-loose text-gray-500">Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit.</p>
                            </div>
                        ...
                        <div class="w-full px-4 md:w-1/2 lg:mt-20">
                            <div class="py-6 pl-6 pr-4 mb-8 bg-white rounded-lg shadow" data-aos="fade-in" data-aos-delay="600">
                            ...
                            <div class="py-6 pl-6 pr-4 bg-white rounded-lg shadow" data-aos="fade-up" data-aos-delay="800">
                                <span class="inline-block p-3 mb-4 bg-green-100 rounded">
                                    <svg class="w-10 h-10 text-green-600" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
        ...
        {{-- <div class="skew skew-bottom mr-for-radius">
            <svg class="w-full h-8 md:h-12 lg:h-20 text-gray-50" viewBox="0 0 10 10" preserveAspectRatio="none">
