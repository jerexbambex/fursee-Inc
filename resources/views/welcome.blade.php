<x-guest-layout>
    <section class="dark:bg-gray-900">
        <div class="oq i_ uj dt fa dark:bg-gray-900">
            <div class="hidden fu fp fh bk mm fs" aria-hidden="true" data-aos="fade-up" data-aos-delay="400">
                <svg class="oz" width="564" height="552" viewbox="0 0 564 552" fill="none"
            ...
            <div class="fa fe wu vx vy">
                <div class="o_ i_ lt aw vy">
                    ...
                    <p class="text-gray-700 dark:text-gray-400 rz sj font-circular-regular" data-aos="fade-up"
                        ...
                        forever. Perfect blend of creative and technically advanced web and mobile solutions for
                    ...
                    <div class="fa np nj nw" data-aos="fade-up" data-aos-delay="200"><img class="i_"
                        ...
                        <a class="fu lx" @click.prevent="modalExpanded = true" href="#0" aria-controls="modal">
                            <svg class="ca rm xl xf wt h_ pt hz" viewbox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path class="text-purple-600 fj"
                                    d="M52 44a.999.999 0 00-.427-.82l-10-7A1 1 0 0040 37V51a.999.999 0 001.573.82l10-7A.995.995 0 0052 44V44c0 .001 0 .001 0 0z">
                                </path>
                            </svg>
                        </a>
                    </div>
                    <div class="fo ff cy gj tx hj" x-show="modalExpanded" x-transition:enter="h_ hq pn"
                        x-transition:enter-start="ur" x-transition:enter-end="us" x-transition:leave="h_ hq pe"
                        x-transition:leave-start="us" x-transition:leave-end="ur" aria-hidden="true" x-cloak=""></div>
                    <div id="modal" class="fo ff cy uu np nw nj he uj dt" role="dialog" aria-modal="true"
                        aria-labelledby="modal-headline" x-show="modalExpanded" x-transition:enter="h_ hq pn"
                        x-transition:enter-start="ur hr" x-transition:enter-end="us hi" x-transition:leave="h_ hq pn"
                        x-transition:leave-start="us hi" x-transition:leave-end="ur hr" x-cloak="">
                        <div class="bg-white uo oq cv oy" @click.away="modalExpanded = false"
                            @keydown.escape.window="modalExpanded = false">
                            <div class="fa fn">
                                <iframe class="fu cv rw" src="https://player.vimeo.com/video/174002812" title="Video"
    ...
    <section>
        <div class="oq i_ uj dt">
            <div class="wo aw vg vw">
                <div class="o_ i_ lt aw vw">
                    <h2 class="text-gray-800 h2 sm dark:text-gray-200" data-aos="fade-up">Why choose FURSEE Inc.</h2>
                    <p class="text-gray-700 rz dark:text-gray-400" data-aos="fade-up" data-aos-delay="200">Fursee Inc. has ambitiously evolved its entity to provide salient solutions in all fields of Computer Applications. It specialises in Software Development, Mobile Development, Website Designing, Development & Maintenance.</p>
                </div>
                <div class="ox i_ nv cx ms _o nb vu">
                    <div class="fa np ng nw" data-aos="fade-up">
                        <div aria-hidden="true" class="hidden fu rl nu yk tj dh"
                        ...
                        <h4 class="text-gray-700 h4 sa dark:text-gray-300">
                            <span class="text-gray-700 dark:text-gray-200">1</span>. Broad Range of Services
                        </h4>
                        <p class="text-gray-700 rq dark:text-gray-400 lt">We offer complete website development, database and application development, search engine optimization, software programming and e-commerce.</p>
                    </div>
                    <div class="fa np ng nw" data-aos="fade-up" data-aos-delay="200">
                        <div aria-hidden="true" class="hidden fu rl nu yk tj dh"
                            style="width:calc(100% - 32px);left:calc(50% + 48px);top:32px" data-aos="fade-in"
                        ...
                        <svg class="ca rm sm" viewbox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <path class="fq wp" stroke-width="2" stroke-linecap="square" d="M36 32l-4-3-4 3V22h8z">
                                </path>
                            </g>
                        </svg>
                        <h4 class="text-gray-700 h4 sa dark:text-gray-300">
                            <span class="text-gray-700 dark:text-gray-200">2</span>. Quality Service
                        </h4>
                        <p class="text-gray-700 rq dark:text-gray-400 lt">Our skilled project managers provide continuous quality control; globally based teams deliver a superior product in terms of design, functionality and usability.</p>
                    </div>
                    <div class="fa np ng nw" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h4 class="text-gray-700 h4 sa dark:text-gray-300">
                            <span class="text-gray-700 dark:text-gray-200">3</span>. Timely Delivery
                        </h4>
                        <p class="text-gray-700 rq dark:text-gray-400 lt">Flexible professional service teams allow us to deliver jobs quickly.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="px-4 py-16 mx-auto bg-gray-100 dark:bg-gray-900 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div class="mx-auto sm:text-center lg:max-w-2xl">
                <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12" data-aos="fade-up">
                    ...
                    <h2
                        class="max-w-lg mb-6 text-3xl font-light leading-none tracking-tight text-gray-800 font-circular dark:text-gray-300 sm:text-4xl md:mx-auto">
                        <span class="relative inline-block">
                            <svg viewBox="0 0 52 24" fill="currentColor"
                                class="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-blue-gray-100 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block">
                                <defs>
                                    <pattern id="5dc90b42-5ed4-45a6-8e63-2d78ca9d3d95" x="0" y="0" width=".135"
                                        height=".30">
                            ...
                            <span class="relative">Let us handle</span>
                        </span>
                        your next Development & Solutions
                    </h2>
                    <p class="text-base text-gray-700 dark:text-gray-500 md:text-lg font-circular">
                    ...
                    <div class="flex flex-wrap w-full lg:w-1/2">
                        <div class="w-full px-4 mb-8 lg:mb-0 md:w-1/2">
                            ...
                            <div class="py-6 pl-6 pr-4 bg-white rounded shadow" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <h4 class="mb-2 text-2xl text-gray-600 font-circular-head font-heading">Mobile App
                                    Development</h4>
                                <p class="leading-loose text-gray-500 font-circular">Android and iOS Mobile Applications
                                    and Software that are build to scale and perform better on low specification
                                    devices.</p>
                            </div>
                        </div>
                        <div class="w-full px-4 md:w-1/2 lg:mt-20">
                            <div class="py-6 pl-6 pr-4 mb-8 bg-white rounded-lg shadow" data-aos="fade-in"
                                ...
                                <h4 class="mb-2 text-2xl text-gray-600 font-circular-head font-heading">UX/UI Design
                                </h4>
                                <p class="leading-loose text-gray-500 font-circular">Leverage the latest UI/UX
                                    technologies, architectures, and trends to design responsive & scalable apps that
                                    transform customer experiences across multiple channels.</p>
                            </div>
                            <div class="py-6 pl-6 pr-4 bg-white rounded-lg shadow" data-aos="fade-up"
                                ...
                                <h4 class="mb-2 text-2xl text-gray-600 font-circular-head font-heading">API Integration
                                </h4>
                                <p class="leading-loose text-gray-500 font-circular">We build custom APIs for all breeds
                                    of applications, adding functionality to your software systems and facilitating
                                    communication between your apps & others.</p>
                            </div>
                        </div>
                    </div>
                </div>
