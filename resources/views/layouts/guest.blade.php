            ...
            <div class="relative z-50 hidden navbar-menu">
                ...
                <nav
                    ...
                    <div>
                        <ul>
                            <li class="mb-1"><a
                                    class="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-green-50 hover:text-green-600"
                                    href="#">Start</a></li>
                            <li class="mb-1"><a
                                    class="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-green-50 hover:text-green-600"
                                    href="#">About Us</a></li>
                    ...
                    <div class="mt-auto">
                        <div class="pt-6"><a
                                class="block px-4 py-3 mb-3 text-xs font-semibold leading-none leading-loose text-center bg-gray-50 hover:bg-gray-100 rounded-l-xl rounded-t-xl"
                                href="#">Sign In</a><a
                                class="block px-4 py-3 mb-2 text-xs font-semibold leading-loose text-center text-white bg-green-600 hover:bg-green-700 rounded-l-xl rounded-t-xl"
                                href="#">Sign Up</a></div>
                ...
                <div class="oq i_ uj dt">
                        ...
                        <div class="kl _f">
                            <div class="sa">
                                <a class="nh" href="index.html" aria-label="Cruip">
                                    <svg class="text-purple-600 co rd fj" viewbox="0 0 32 32"
                            ...
                            <div class="text-blue-gray-600 dark:text-blue-gray-300">Fursee Inc. is focusing in the areas
                                of Software Development, Web Development and Consultancy, e-Governance, e-Business & ERP
                                Solutions, Web Hosting, Computer Graphics & Designing to clients located locally and
                                internationally in various domains..</div>
                        </div>
                        <div class="kc _l nv xc cx">
                            <div class="r_">
                                <h6 class="font-semibold tracking-wide si text-blue-gray-700 dark:text-blue-gray-300">
                                    Products</h6>
                                <ul>
                                    <li class="si">
                                        <a class="text-blue-gray-500 dark:text-blue-gray-400 h_ pt hz hover:text-blue-gray-900 dark:hover:text-blue-gray-100"
                                            href="#0">Web Development</a>
                                    </li>
                                    <li class="si">
                                        <a class="text-blue-gray-500 dark:text-blue-gray-400 h_ pt hz hover:text-blue-gray-900 dark:hover:text-blue-gray-100"
                                            href="#0">Mobile Development</a>
                                    </li>
                                    <li class="si">
                                        <a class="text-blue-gray-500 dark:text-blue-gray-400 h_ pt hz hover:text-blue-gray-900 dark:hover:text-blue-gray-100"
                                            href="#0">UI & UX Design</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="r_">
                                <h6 class="font-semibold tracking-wide text-blue-gray-700 dark:text-blue-gray-300 si">
                                    Resources</h6>
                                <ul>
                                    <li class="si">
                                        <a class="text-blue-gray-500 dark:text-blue-gray-400 h_ pt hz hover:text-blue-gray-900 dark:hover:text-blue-gray-100"
                    ...
                    <div class="dp dm dy">
                        <ul class="np sm dx vt ve">
                            ...
                            <li class="sg">
                                <a class="text-blue-gray-600 np nj nw wy yf nr h_ pt hz" href="#0"
                                    aria-label="Facebook">
                                    <svg class="co rd fj" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                        <path
...
<script>
    ...
    function isMenuOpen() {
        alert(11);
        // document.getElementById("my-menu").toggle();
    }
    // function isMenuOpen() {
    //     return false
    // }
